    ...
    <div class="w-3/3 mt-20 mb-20 ml-10">
        <form @submit.prevent="submitHandler">
            <div>
                ...
                <input v-model="formData.allergies" type="input" id="allergies" placeholder="add allergies"  class="w-60 placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm"/>
